...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 主题管理 <span class="c-gray en">&gt;</span> 全部主题 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
    ...
    <table class="table table-border table-bordered table-bg">
        ...
        <tr class="text-c">
            <th width="40">ID</th>
            <th width="150">主题图</th>
            <th width="130">主题标题</th>
					<th width="130">主题链接</th>
        ...
        <?php if(is_array($adv_list)): $i = 0; $__LIST__ = $adv_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$adv): $mod = ($i % 2 );++$i;?><tr class="text-c">
				...
				<td><?php echo ($adv["action"]); ?></td>
				<td><?php echo (date('Y-m-d H:i',$adv["addtime"])); ?></td>
                <td>
